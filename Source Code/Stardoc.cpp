// StarDoc.cpp : implementation of the CStarDrawDoc class
//
...
IMPLEMENT_DYNCREATE(CStarDrawDoc, COleServerDoc)

BEGIN_MESSAGE_MAP(CStarDrawDoc, COleServerDoc)
	//{{AFX_MSG_MAP(CStarDrawDoc)
...
/////////////////////////////////////////////////////////////////////////////
// CStarDrawDoc construction/destruction

CStarDrawDoc::CStarDrawDoc()
{
...
BOOL CStarDrawDoc::OnNewDocument()
{
...
/////////////////////////////////////////////////////////////////////////////
// CStarDrawDoc serialization

void CStarDrawDoc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
		ar << m_sizeDoc;
...
/////////////////////////////////////////////////////////////////////////////
// CStarDrawDoc diagnostics

#ifdef _DEBUG
void CStarDrawDoc::AssertValid() const
{
	COleServerDoc::AssertValid();
}

void CStarDrawDoc::Dump(CDumpContext& dc) const
{
...
/////////////////////////////////////////////////////////////////////////////
// CStarDrawDoc commands

BOOL CStarDrawDoc::OnOpenDocument(LPCTSTR lpszPathName) 
{
...
void CStarDrawDoc::DeleteContents() 
{
...
void CStarDrawDoc::InitDocument()
{
	m_bThickPen = FALSE;
...
CStroke* CStarDrawDoc::NewStroke()
{
...
void CStarDrawDoc::OnEditClearAll() 
{
	DeleteContents();
	SetModifiedFlag();  // Mark the document as having been modified, for
						// purposes of confirming File Close.
...
void CStarDrawDoc::OnPenThickOrThin() 
{
...
void CStarDrawDoc::OnUpdateEditClearAll(CCmdUI* pCmdUI) 
{
...
void CStarDrawDoc::OnUpdatePenThickOrThin(CCmdUI* pCmdUI) 
{
...
COleServerItem* CStarDrawDoc::OnGetEmbeddedItem()
{
	// OnGetEmbeddedItem is called by the framework to get the COleServerItem
	//  that is associated with the document.  It is only called when necessary.

	CStarDrawItem* pItem = new CStarDrawItem(this);
	ASSERT_VALID(pItem);
	return pItem;
}

void CStarDrawDoc::OnSetItemRects(LPCRECT lpPosRect, LPCRECT lpClipRect)
{
	...
	CStarDrawView* pView = (CStarDrawView*)GetNextView(pos);
	pView->ResyncScrollSizes();
}

void CStarDrawDoc::OnEditCopy()
{
	CStarDrawItem* pItem = GetEmbeddedItem();
