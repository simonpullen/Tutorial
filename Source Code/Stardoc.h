// StarDrawDoc.h : interface of the CStarDrawDoc class
//
...
// class CStroke
//
// A stroke is a series of connected points in the StarDraw drawing.
// A StarDraw document may have multiple strokes.
...
class CStarDrawDoc : public COleServerDoc
{
protected: // create from serialization only
	CStarDrawDoc();
	DECLARE_DYNCREATE(CStarDrawDoc)

// Attributes
protected:
	// The document keeps track of the current pen width on
	// behalf of all views. We'd like the user interface of
	// StarDraw to be such that if the user chooses the Draw
...
public:
	...
	CStarDrawItem* GetEmbeddedItem()
		{ return (CStarDrawItem*)COleServerDoc::GetEmbeddedItem(); }
