// StarVw.cpp : implementation of the CStarDrawView class
//
...
IMPLEMENT_DYNCREATE(CStarDrawView, CScrollView)

BEGIN_MESSAGE_MAP(CStarDrawView, CScrollView)
	//{{AFX_MSG_MAP(CStarDrawView)
	ON_WM_LBUTTONDOWN()
	ON_WM_LBUTTONUP()
	ON_WM_MOUSEMOVE()
...
/////////////////////////////////////////////////////////////////////////////
// CStarDrawView construction/destruction

CStarDrawView::CStarDrawView()
{
...
BOOL CStarDrawView::PreCreateWindow(CREATESTRUCT& cs)
{
...
/////////////////////////////////////////////////////////////////////////////
// CStarDrawView drawing

void CStarDrawView::OnDraw(CDC* pDC)
{
	CStarDrawDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
/////////////////////////////////////////////////////////////////////////////
// CStarDrawView printing

BOOL CStarDrawView::OnPreparePrinting(CPrintInfo* pInfo)
{
...
void CStarDrawView::OnBeginPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
	// TODO: add extra initialization before printing
}

void CStarDrawView::OnEndPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
	// TODO: add cleanup after printing
}

/////////////////////////////////////////////////////////////////////////////
// CStarDrawView diagnostics

#ifdef _DEBUG
void CStarDrawView::AssertValid() const
{
	CScrollView::AssertValid();
}

void CStarDrawView::Dump(CDumpContext& dc) const
{
	CScrollView::Dump(dc);
}

CStarDrawDoc* CStarDrawView::GetDocument() // non-debug version is inline
{
	ASSERT(m_pDocument->IsKindOf(RUNTIME_CLASS(CStarDrawDoc)));
	return (CStarDrawDoc*)m_pDocument;
}
#endif //_DEBUG

/////////////////////////////////////////////////////////////////////////////
// CStarDrawView message handlers

void CStarDrawView::OnLButtonDown(UINT, CPoint point) 
{
...
void CStarDrawView::OnLButtonUp(UINT, CPoint point) 
{
	// Mouse button up is interesting in the StarDraw application
...
void CStarDrawView::OnMouseMove(UINT, CPoint point) 
{
	// Mouse movement is interesting in the StarDraw application
	// only if the user is currently drawing a new stroke by dragging
	// the captured mouse.
...
void CStarDrawView::OnUpdate(CView* /* pSender */, LPARAM /* lHint */, 
	CObject* pHint) 
{
...
void CStarDrawView::OnInitialUpdate() 
{
        ResyncScrollSizes();
	CScrollView::OnInitialUpdate();
}

void CStarDrawView::ResyncScrollSizes()
{
	CClientDC dc(NULL);
	OnPrepareDC(&dc);
...
void CStarDrawView::OnPrint(CDC* pDC, CPrintInfo* pInfo) 
{
...
void CStarDrawView::PrintTitlePage(CDC* pDC, CPrintInfo* pInfo)
{
...
void CStarDrawView::PrintPageHeader(CDC* pDC, CPrintInfo* pInfo,
	CString& strHeader)
{
...
void CStarDrawView::OnCancelEditSrvr() 
{
	GetDocument()->OnDeactivateUI(FALSE);
}

void CStarDrawView::OnPrepareDC(CDC* pDC, CPrintInfo* pInfo) 
{
	CStarDrawDoc* pDoc = GetDocument();
...
void CStarDrawView::OnSize(UINT nType, int cx, int cy) 
{
